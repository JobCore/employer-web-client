...
const Button = ({ color, onClick, propagate, icon, children, className, note, rounded, size, onMouseEnter, onMouseLeave, onFocus, notePosition, withAlert, style, disable, id}) => {
    return (
        <button
            style={style}
            type="button"
