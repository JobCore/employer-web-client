...
export class DeductionsReport extends Flux.DashView {
  ...
  render() {
            ...
            ...payrollPeriods
              ...
              .map((period) => {
                return {
                  label:
                    "From " +
                    moment(period.starting_at).format("MMM DD, YYYY") +
                    " to " +
                    moment(period.ending_at).format("MMM DD, YYYY"),
                  value: period.id,
                };
              }),
          ]
    ...
    return (
      <div className="p-1 listcontents" style={{ maxWidth: "1100px" }}>
        <Theme.Consumer>
          {({ bar }) => (
            <span>
              <div>
                ...
                <div className="row mb-4">
                  <div className="col-4">
                    ...
                    <Select
                      options={options}
                      onChange={(selection) =>
                        this.setState({ period: selection.value }, () =>
                          this.getDeductions()
                        )
                      }
                    />
                          ...
                          return (
                            <tr key={i}>
                              ...
                              <td>
                                <div>
                                  {deduction.deduction_list &&
                                  deduction.deduction_list.length > 0
