...
var _shiftCard = require('../shift-card');

var _shiftCard2 = _interopRequireDefault(_shiftCard);
...
var DashboardBox = function DashboardBox(_ref) {
    ...
    var shiftsHTML = shifts.map(function (s, i) {
        return _react2.default.createElement(_shiftCard2.default, { key: i, shift: s });
    });
